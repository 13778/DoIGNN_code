...
class DiscreteGraphLearning(nn.Module):
    ...
    def __init__(self, dataset_name, k, input_seq_len, output_seq_len):
        ...
        self.num_nodes = {"CMADS_SPECIHUMIDITY": 130, "CMADS_SOLAR": 130, "CMADS_PRECIP": 130, "CMADS_AVE_TEM": 130, "CMADS_AVE_TEM_Decomp": 130, "CMADS_AVE_TEM": 130, "CMADS_AVE_TEM": 130, "METR-LA": 207, "PEMS04": 307, "PEMS03": 358, "PEMS-BAY": 325, "PEMS07": 883, "PEMS08": 170}[dataset_name]
        self.train_length = {"CMADS_SPECIHUMIDITY": 10212, "CMADS_SOLAR": 10212, "CMADS_PRECIP": 10212, "CMADS_AVE_TEM": 10212, "CMADS_AVE_TEM_Decomp": 10212, "CMADS_AVE_TEM": 10212, "METR-LA": 23990, "PEMS04": 13599, "PEMS03": 15303, "PEMS07": 16513, "PEMS-BAY": 36482, "PEMS08": 14284}[dataset_name]
        ...
        ## for the dimension, see https://github.com/zezhishao/DoIGNN/issues/1#issuecomment-1191640023
        self.dim_fc = {"CMADS_SPECIHUMIDITY": 163104, "CMADS_SOLAR": 163104, "CMADS_PRECIP": 163104, "CMADS_AVE_TEM": 163104, "CMADS_AVE_TEM_Decomp": 163104, "CMADS_AVE_TEM": 163104, "METR-LA": 383552, "PEMS04": 217296, "PEMS03": 244560, "PEMS07": 263920, "PEMS-BAY": 583424, "PEMS08": 228256}[dataset_name]
        ...
        # FC for transforming the features from AUTOENCODER
        ## for the dimension, see https://github.com/zezhishao/DoIGNN/issues/1#issuecomment-1191640023
        self.dim_fc_mean = {"CMADS_SPECIHUMIDITY": 16128, "CMADS_SOLAR": 16128, "CMADS_PRECIP": 16128, "CMADS_AVE_TEM": 16128, "CMADS_AVE_TEM_Decomp": 16128, "CMADS_AVE_TEM": 16128, "METR-LA": 16128, "PEMS-BAY": 16128, "PEMS03": 16128 * 2, "PEMS04": 16128 * 2, "PEMS07": 16128, "PEMS08": 16128 * 2}[dataset_name]
    ...
    def forward(self, long_term_history, autoencoder):
        """Learning discrete graph structure based on AUTOENCODER.

        Args:
            long_term_history (torch.Tensor): very long-term historical MTS with shape [B, P * L, N, C], which is used in the AUTOENCODER.
                                                P is the number of segments (patches), and L is the length of segments (patches).
            autoencoder (nn.Module): the pre-trained AUTOENCODER.

        Returns:
            torch.Tensor: Bernoulli parameter (unnormalized) of each edge of the learned dependency graph. Shape: [B, N * N, 2].
            torch.Tensor: the output of AUTOENCODER with shape [B, N, P, d].
        ...
        # generate dynamic feature based on AUTOENCODER
        hidden_states = autoencoder(long_term_history[..., [0]])
        ...
        # prior graph based on AUTOENCODER
