...
from basicts.metrics import masked_mae, masked_rmse, masked_mape, masked_kge, masked_nse


class DoIGNNRunner(BaseTimeSeriesForecastingRunner):
    def __init__(self, cfg: dict):
        super().__init__(cfg)
        self.metrics = cfg.get("METRICS", {"MAE": masked_mae, "RMSE": masked_rmse, "MAPE": masked_mape, "NSE": masked_nse, "KGE": masked_kge})
